...
def main():
    out_dir = Path(r"C:\\GITHUB Repos\\RoboSim_Navigation_Trainer\\Docs3\\work\\ppo_trainer")
    out_dir.mkdir(parents=True, exist_ok=True)
    ...
    try:
        ...
        from train_ppo import TrainingGui
        app = TrainingGui(); app.root.update_idletasks(); app.root.update()
        ...
        _capture_one(target, out_dir, "ppo_trainer", scaling)
