...
def main():
    out_dir = Path(r"C:\\GITHUB Repos\\RoboSim_Navigation_Trainer\\Docs3\\work\\benchmark_gui")
    out_dir.mkdir(parents=True, exist_ok=True)
    ...
    try:
        ...
        app = BenchmarkGui(); app.root.update_idletasks(); app.root.update()
        ...
        _capture_one(target, out_dir, "benchmark_gui", scaling)
        ...
        for peer, slug in _enumerate_peer_toplevels(target):
            sub_name = f"benchmark_gui__{slug}"
